...
export default function Agents() {
  return (
    <>
      <SEOHead
        title="20 AI Agents - Automate Every Aspect of Residential Care Operations"
        description="Meet our 20 specialized AI agents: DocuBot for documentation, Sentinel for health monitoring, Guardian for compliance, Compass for care plans, and 16 more. Transform your facility operations with 70% time savings."
      />
      <AgentsContent />
    </>
  );
  ...
  const agents = [
    {
      ...
      description:
        "DocuBot transforms voice notes into compliant clinical documentation in seconds. Simply speak naturally about resident care, and DocuBot generates properly formatted, regulation-compliant notes with all required elements.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Reduces documentation time from 2 hours to 30 minutes per shift",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Sentinel continuously monitors resident health data to predict potential crises before they happen. Using advanced ML models, it detects subtle patterns that indicate UTIs, falls, medication issues, or behavioral changes 24-48 hours in advance.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Guardian ensures 100% regulatory compliance 24/7 by continuously monitoring all operations against federal, state, and provincial requirements. It automatically flags gaps, suggests corrections, and generates inspection-ready reports.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Zero compliance violations in facilities using Guardian for 6+ months",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Compass creates dynamic, person-centered care plans that evolve with each resident's changing needs. It analyzes resident preferences, health data, and outcomes to suggest evidence-based interventions tailored to individual goals.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Residents reach care plan goals 40% faster than traditional methods",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Nexus solves staffing crises in seconds by optimizing schedules based on certifications, resident acuity, overtime rules, and staff preferences. When someone calls out sick, Nexus instantly finds the best replacement and sends notifications.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Connect strengthens family relationships by automating personalized updates, scheduling visits, and facilitating communication. Families receive photo updates, care summaries, and can message staff directly through a secure portal.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Insight transforms raw data into actionable intelligence with 7 comprehensive dashboards. Track KPIs, identify trends, benchmark performance, and make data-driven decisions to improve outcomes and profitability.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Facilities save $50K-$200K annually through data-driven optimization",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Mentor ensures 100% staff certification compliance by tracking training requirements, auto-assigning courses, and monitoring completion. It integrates with LMS platforms and sends reminders before certifications expire.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Steward optimizes financial performance by tracking revenue, expenses, and profitability in real-time. It identifies cost-saving opportunities, forecasts cash flow, and ensures accurate billing and collections.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Advocate drives continuous quality improvement by tracking quality indicators, identifying improvement opportunities, and managing QAPI initiatives. It ensures facilities meet and exceed quality standards.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Reduces falls, medication errors, and infections through proactive monitoring",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Harmony provides evidence-based behavioral support by analyzing triggers, tracking interventions, and suggesting de-escalation strategies. It helps staff understand and respond to challenging behaviors with compassion and effectiveness.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Behavioral incidents decrease by 60% within 3 months of implementation",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Vanguard ensures medication safety by checking for drug interactions, allergies, and administration errors in real-time. It integrates with pharmacies via Surescripts and provides barcode scanning for error-proof administration.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Prevents 9 out of 10 potential medication errors before they occur",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Catalyst streamlines admissions by managing inquiries, scheduling tours, and tracking leads through the sales funnel. It automates follow-ups, generates marketing materials, and ensures no opportunity is missed.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Increases move-ins by converting 25% more inquiries to admissions",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Pulse boosts staff morale and retention through gamification, recognition, and engagement tracking. It celebrates achievements, tracks satisfaction, and identifies burnout risks before staff leave.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Reduces staff turnover from 60% to 30% through recognition and engagement",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Sentinel Pro manages the entire incident lifecycle from reporting to resolution. It ensures timely investigation, root cause analysis, corrective actions, and regulatory notifications are completed on schedule.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Zero late incident reports and automatic regulatory compliance",
      },
      features: [
    ...
    },
    {
      ...
      color: "from-violet-500 to-purple-600",
      description:
        "Executive Assistant provides C-suite and board members with strategic insights, automated reporting, and data-driven recommendations. It consolidates facility performance across all metrics into executive dashboards and generates board-ready presentations.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Reduces executive reporting time from 20 hours to 4 hours per month",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "HR Manager streamlines the entire employee lifecycle from recruitment to offboarding. It automates job postings, screens candidates, manages onboarding, tracks performance reviews, and handles employee relations issues with built-in HR best practices.",
      useCases: [
    ...
    },
    {
      ...
      color: "from-amber-500 to-yellow-600",
      description:
        "Maintenance Coordinator ensures your facility stays safe and operational by managing work orders, scheduling preventive maintenance, tracking equipment lifecycles, and conducting safety inspections. It prevents costly emergency repairs through proactive maintenance scheduling.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Nutrition Specialist manages all aspects of food service from menu planning to meal delivery. It ensures dietary restrictions are followed, generates shopping lists, tracks food costs, and monitors nutritional adequacy for each resident's specific needs.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "Zero dietary violations and improved resident satisfaction with meals",
      },
      features: [
    ...
    },
    {
      ...
      description:
        "Transportation Manager coordinates all resident transportation needs including medical appointments, family visits, community outings, and recreational activities. It optimizes routes, manages driver schedules, tracks vehicle maintenance, and ensures no resident misses an important appointment.",
      useCases: [
      ...
      impact: {
        ...
        detail:
          "100% on-time transportation with automated scheduling and reminders",
      },
      features: [
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto max-w-5xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            20 specialized AI agents working 24/7 to automate workflows, predict
            crises, ensure compliance, and elevate care quality. Each agent is a
            domain expert designed to solve specific challenges in residential
            care management.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAgents.map(agent => {
              ...
              return (
                <Card
                  key={agent.id}
                  className="p-6 hover:shadow-xl hover:border-primary/30 transition-all group"
                >
                  {/* Agent Header */}
                  <div className="flex items-start gap-4 mb-4">
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${agent.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}
                    >
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            All 20 agents work together seamlessly to transform your facility
            operations. Start your free trial and see the difference in days,
            not months.
          </p>
