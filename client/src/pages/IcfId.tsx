  ...
  const challenges = [
    {
      ...
      description:
        "Navigating 42 CFR Part 483 requirements, active treatment mandates, and continuous compliance monitoring.",
    },
    {
      icon: Target,
      title: "Active Treatment Requirements",
      description:
        "Documenting individualized active treatment programs, measurable goals, and quarterly progress reviews.",
    },
    {
      icon: FileText,
      title: "Extensive Documentation Burden",
      description:
        "ISPs, quarterly reviews, behavioral data, incident reports, and daily progress notes for every resident.",
    },
    {
      icon: Users,
      title: "Larger Resident Populations",
      description:
        "Managing care for 16-50+ residents with diverse needs, behaviors, and medical complexities.",
    },
    {
      icon: GraduationCap,
      title: "Staff Training & Certification",
      description:
        "Ensuring all staff maintain required certifications, training hours, and competency assessments.",
    },
    {
      icon: Clock,
      title: "Survey Readiness",
      description:
        "Maintaining continuous survey readiness with proper documentation, policies, and quality assurance.",
    },
  ];
  ...
  const recommendedAgents = [
    {
      ...
      benefit:
        "Real-time alerts for regulatory gaps, automatic survey-ready reports",
      priority: "Essential",
    },
    {
      name: "Compass",
      ...
      description:
        "AI-powered ISP development with active treatment integration",
    ...
    },
    {
      ...
      description:
        "Voice-to-text for progress notes, behavioral data, and incident reports",
    ...
    },
    {
      ...
      description:
        "Predictive health monitoring for medically complex residents",
    ...
    },
    {
      ...
      description:
        "Intelligent scheduling for DSPs, QIDPs, and specialized staff",
  ...
  const useCases = [
    {
      ...
      scenario:
        "QIDP needs to develop an ISP for a new resident with complex behavioral and medical needs, including active treatment goals.",
      before:
        "8-10 hours to research, write, and format ISP with measurable goals",
      after:
        "Compass generates compliant ISP draft in 45 minutes with AI-suggested goals based on assessments",
      agents: ["Compass", "Sentinel", "DocuBot"],
    },
    {
      title: "Active Treatment Documentation",
      scenario:
        "DSP delivers active treatment activities throughout the day and needs to document progress toward ISP goals.",
      before:
        "30-45 minutes of documentation after shift, often incomplete or delayed",
      after:
        "DocuBot captures voice notes during activities, auto-links to ISP goals, generates compliant progress notes",
      agents: ["DocuBot", "Compass"],
    },
    {
      title: "Federal Survey Preparation",
      scenario:
        "State survey team announces they'll arrive in 48 hours for annual inspection.",
      before:
        "Frantic 48-hour scramble to gather documents, finding gaps in ISPs and training records",
      after:
        "Guardian provides survey-ready documentation package in 15 minutes, identifies and resolves gaps proactively",
      agents: ["Guardian", "Catalyst", "Vanguard"],
    },
    {
      title: "Behavioral Crisis Management",
      scenario:
        "Resident exhibits escalating behavioral episode requiring intervention and documentation.",
      before:
        "Paper incident report completed hours later, missing critical details and timeline",
      after:
        "Sentinel Pro captures incident via voice in real-time, auto-generates state report, triggers investigation workflow",
      agents: ["Sentinel Pro", "DocuBot", "Sentinel"],
    },
    {
      title: "Medication Administration Round",
      scenario:
        "Nurse conducts morning medication pass for 25 residents with complex medication regimens.",
      before:
        "Paper MAR with frequent transcription errors, missed allergy checks",
      after:
        "Vanguard provides digital eMAR with barcode scanning, allergy alerts, and automatic documentation",
  ...
  const complianceFeatures = [
    {
      ...
      solution:
        "Compass generates ISPs with measurable active treatment goals, tracks progress, alerts to missed activities",
    },
    {
      regulation: "42 CFR 483.420",
      requirement: "Client Protections",
      solution:
        "Guardian monitors rights restrictions, tracks incident reports, ensures proper documentation",
    },
    {
      regulation: "42 CFR 483.430",
      requirement: "Facility Staffing",
      solution:
        "Nexus ensures proper staffing ratios, tracks QIDP coverage, manages certification requirements",
    },
    {
      regulation: "42 CFR 483.460",
      requirement: "Health Care Services",
      solution:
        "Sentinel monitors health status, Vanguard manages medications, integrated care coordination",
    },
    {
      regulation: "42 CFR 483.480",
      requirement: "Condition of Participation",
      solution:
        "Guardian provides continuous compliance monitoring across all CoPs with real-time alerts",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Guardian continuously monitors all operations against federal ICF-ID regulations, providing real-time alerts for any gaps. The system is updated automatically when regulations change, and generates survey-ready documentation packages on demand. Every feature is designed with CFR compliance built-in.",
    },
    {
      question: "Can Harmony help with active treatment documentation?",
      answer:
        "Absolutely! Compass integrates active treatment directly into ISPs with measurable goals, and DocuBot allows staff to document active treatment delivery in real-time via voice. The system automatically tracks progress toward goals and alerts when activities are missed.",
    },
    {
      question: "What's the implementation timeline for a 30-resident ICF-ID?",
      answer:
        "Most ICF-ID facilities are fully operational within 3-4 weeks. We provide white-glove migration support including ISP import, staff training (on-site or virtual), and dedicated QIDP training. You'll start seeing compliance improvements from week one.",
    },
    {
      question:
        "Does Harmony integrate with our existing EHR or pharmacy system?",
      answer:
        "Yes! We offer API integrations with major EHR systems, pharmacy platforms, and state reporting portals. Our team handles the technical integration, and we can build custom integrations for your specific systems.",
    },
    {
      question: "How does pricing work for larger ICF-ID facilities?",
      answer:
        "ICF-ID facilities typically use our Professional plan at $79/resident/month for 11-50 residents, or Enterprise plan at $99/resident/month for 50+ residents. Enterprise includes custom integrations, dedicated account management, and white-label options.",
    },
    {
      question: "Can Harmony help us prepare for our annual survey?",
      answer:
        "Yes! Guardian maintains continuous survey readiness by monitoring all compliance areas 24/7. When a survey is announced, it generates a complete documentation package in minutes, identifies any gaps, and provides remediation guidance. Many facilities report zero deficiencies after implementing Harmony.",
    },
  ];
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Purpose-built for intermediate care facilities serving individuals
              with intellectual disabilities. Ensure 100% compliance with 42 CFR
              Part 483, streamline active treatment documentation, and pass
              surveys with zero deficiencies.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We understand the complex regulatory and operational demands of
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-accent/5 to-background">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              10 AI agents specifically designed to address ICF-ID regulatory
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-2">
              Save <strong className="text-foreground">61-65% off</strong>{" "}
              regular pricing forever +{" "}
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-sm">
                    42 CFR Part 483 compliance monitoring
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-sm">
                    ISP development with active treatment
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-sm">
                    eMAR with medication management
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-accent/5 to-background">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join leading ICF-ID facilities achieving 100% compliance, zero
            survey deficiencies, and dramatically reduced administrative burden
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/demo">
              <Button
