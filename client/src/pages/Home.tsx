...
import {
  ...
  ROIBreakdownChart,
  EfficiencyGauges,
} from "@/components/CostSavingsChart";
  ...
  const features = [
    {
      ...
      description:
        "Speak naturally, get compliant notes instantly. No more typing for hours.",
    },
    {
      icon: Shield,
      title: "Predictive Health Monitoring",
      description:
        "AI detects subtle patterns and alerts you before crises occur.",
    },
    {
      icon: CheckCircle2,
      title: "Automated Compliance Reporting",
      description:
        "Always inspection-ready with continuous monitoring and one-click reports.",
    },
    {
      icon: Calendar,
      title: "Intelligent Scheduling",
      description:
        "Solve staffing crises in seconds with AI-powered optimization.",
    },
    {
      icon: Users,
      title: "Family Engagement Portal",
      description:
        "Keep families connected with daily updates, photos, and two-way messaging.",
    },
    {
      icon: TrendingUp,
      title: "Real-Time Analytics",
      description:
        "Data-driven insights to improve care quality and operational efficiency.",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-primary/20 border border-primary/30 rounded-full px-5 py-2 mb-8 animate-fade-in">
              ...
              <span className="text-sm font-medium text-accent">
                Pre-Launch • Early Access Sign-Up
              </span>
            </div>
            ...
            <div className="relative max-w-4xl mx-auto mb-12 animate-fade-in-up delay-200">
              <div
                className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-primary/20 border border-primary/20 group cursor-pointer"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up delay-300">
              ...
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-8 text-base font-semibold border-white/20 hover:bg-white/10"
            ...
            <div className="mt-24 space-y-20">
              ...
              <div>
                <h3 className="text-3xl font-bold text-center mb-4">
                  Your Path to $156K+ Annual Savings
                </h3>
                <p className="text-center text-muted-foreground mb-8">
                  See how Harmony delivers measurable ROI from day one
                </p>
              ...
              <div>
                <h3 className="text-3xl font-bold text-center mb-4">
                  Reclaim 70% of Your Team's Time
                </h3>
                <p className="text-center text-muted-foreground mb-8">
                  Transform paperwork hours into resident care moments
                </p>
                <div className="bg-card p-8 rounded-2xl border border-border shadow-lg">
                  <TimeAllocationCharts />
                </div>
              ...
              <div>
                ...
                <p className="text-center text-muted-foreground mb-8">
                  $156K+ in annual cost reductions across four key areas
                </p>
                <div className="bg-card p-8 rounded-2xl border border-border shadow-lg">
                  <ROIBreakdownChart />
                </div>
              ...
              <div>
                ...
                <p className="text-center text-muted-foreground mb-8">
                  Track the metrics that matter most to your facility
                </p>
                <div className="bg-card p-8 rounded-2xl border border-border shadow-lg">
                  <EfficiencyGauges />
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-4">
              ...
              <span className="text-primary font-bold">
                $52-$69/resident/month
              </span>
            </p>
            <p className="text-lg text-muted-foreground mb-2">
              <strong className="text-foreground">Save 56-65% off</strong>{" "}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="mt-12 text-center">
            <p className="text-sm text-muted-foreground mb-4">
              Integrates with leading healthcare platforms
            </p>
            <div className="flex flex-wrap justify-center gap-6 items-center">
              <span className="px-4 py-2 bg-background rounded-lg border text-sm font-medium">
                Epic EHR
              </span>
              <span className="px-4 py-2 bg-background rounded-lg border text-sm font-medium">
                Cerner
      ...
      <section className="py-24 bg-gradient-to-b from-background to-card relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Join the future of residential care management. Schedule a
      ...
      <footer className="py-12 bg-card border-t border-border">
        <div className="container mx-auto px-6">
          ...
          <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>
              © 2025 {APP_TITLE}. All rights reserved. | HIPAA Compliant | SOC
              2 Certified
            </p>
          </div>
        </div>
