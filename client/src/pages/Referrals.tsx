...
export default function Referrals() {
  return (
    <>
      <SEOHead
        title="Referral Program - Earn Rewards by Sharing HarmonyCare"
        description="Join HarmonyCare's referral program and earn exclusive rewards. Refer care facilities and unlock benefits from free months to lifetime discounts. Track your referrals and celebrate milestones together."
      />
      <ReferralsContent />
    </>
  );
...
function ReferralsContent() {
  ...
  const { data: referralData, isLoading } = trpc.referral.myReferrals.useQuery(
    undefined,
    {
      enabled: !!user,
    }
  ...
  const { data: milestonesData } = trpc.referral.milestones.useQuery(
    undefined,
    {
      enabled: !!user,
  ...
  useEffect(() => {
    if (
      milestonesData?.unviewed &&
      milestonesData.unviewed.length > 0 &&
      !activeMilestone
    ) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Share HarmonyCare and earn exclusive rewards
          </p>
        </div>
              ...
              {currentTier ? (
                <>
                  <div className="text-2xl font-bold">
                    {currentTier.badge} {currentTier.name.split(" ")[1]}
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
                    {currentTier.name}
                  </p>
          ...
          <Card>
            ...
            <CardContent>
              {nextTier ? (
                <>
                  <div className="text-2xl font-bold">
                    {nextTier.referralsRequired - totalReferrals}
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
        ...
        {nextTier && (
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                {nextTier.referralsRequired - totalReferrals} more referral
                {nextTier.referralsRequired - totalReferrals > 1 ? "s" : ""}{" "}
                needed
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex justify-between text-sm text-muted-foreground">
                  <span>
                    {currentTier ? currentTier.referralsRequired : 0} referrals
                  </span>
                  <span className="font-semibold text-primary">
                    {totalReferrals} current
                  </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Copy and share this link to track your referrals
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Unlock exclusive benefits as you refer more members
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Founding members who joined using your code
            </CardDescription>
          </CardHeader>
          <CardContent>
